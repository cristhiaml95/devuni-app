-- =====================================================
-- FUNCIONES RPC FALTANTES PARA SUPABASE
-- =====================================================
-- Ejecuta este script en el SQL Editor de Supabase Dashboard
-- para resolver los errores de funciones faltantes

-- 1. Función para obtener apps donde el usuario es miembro
...
-- 3. Función para crear app y membresía
...
-- 4. Permisos RLS para las funciones (si es necesario)
-- Nota: Estas funciones usan SECURITY DEFINER para ejecutarse con permisos elevados
...
-- 3. Verifica que las funciones aparezcan en la consulta final
-- 4. Recarga la aplicación Flutter para probar
-- =====================================================